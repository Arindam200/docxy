  ...
  return (
    <div className="rounded-md border border-rule bg-surface px-4 py-4">
      ...
      <p className="mt-1.5 text-xs leading-relaxed text-muted">
        ...
        {missing.length === 1 ? "this variable" : "these variables"}{" "}
        {localDev ? (
          <>
            in <code className="font-mono text-foreground">web/.env.local</code> and restart.
          </>
        ) : (
          "on the hosting platform, then redeploy."
        )}
      </p>
